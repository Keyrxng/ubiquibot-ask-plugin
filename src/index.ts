...
`;
  ...
  const availableFunctions = {
    generate_erc20_permit: (e) => fetch("https://ubiquibot-worker.keyrxng7749.workers.dev", e),
    generate_nft_permit: (e) => fetch("https://ubiquibot-worker.keyrxng7749.workers.dev", e),
  };
